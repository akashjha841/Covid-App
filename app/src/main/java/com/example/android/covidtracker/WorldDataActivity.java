...
//    private CovidActivity activity = new CovidActivity();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.nav_world_data);
        ...
        getSupportActionBar().setTitle("Covid Data World");
        ...
        lin_countrywise.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(WorldDataActivity.this, ListCountryDataActivity.class));
